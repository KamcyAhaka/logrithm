...
import { Zap, TrendingUp, AlertCircle, Share2, HelpCircle, Check, Copy } from 'lucide-react';
...
export default function InsightPanel({
  ...
  return (
    ...
    >
      ...
      {/* ── State: Empty ── */}
      {!loading && (!error || isLimitError) && !insights && <ReadyState onRun={onRun} />}

      {/* ── State: Loaded ── */}
      {!loading && (!error || isLimitError) && insights && (
        <div
          style={{
            flex: 1,
            overflowY: 'auto',
